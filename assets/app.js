...
(function () {
  ...
  /* An iframe that withholds allow-downloads blocks a page-initiated save and
     reports nothing, so detect the frame and say so instead of failing
     silently under the reader's click. */
